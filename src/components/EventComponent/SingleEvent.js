...
import CraftersConfrenceRegistration from '../ModalPages/CraftersConfrenceRegistration'
  ...
  render() {
   ...
   const button=(<button className="btn btn-white" onClick={this.onCloseclick}>Register Event</button>);
    ...
    return(
      ...
      {this.state.closeModal?<CraftersConfrenceRegistration  onSubmit={(data)=>this.onSubmit(data)} onClick={this.onCloseclick}/>:("")}
